...
def plot_model_cuts_comparison(model_linear_func, model_quadratic_func, output_dir="apiV2/comparaisons_modeles"):
    ...
    """
    # 1. Tu entres tes équations dénormalisées exactes du rapport régression linéaire A.D.
    ...
    #equation_quadratique = lambda T, Tout, Q: ( 6.51755e-6 * Q - 0.0008876 * T * Tout + 0.965467 * T + 0.00038276 * Tout**2 + 0.0204 * Tout + 0.67623)
